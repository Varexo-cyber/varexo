      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Full-stack webdevelopment studio. {t('footer.description')}
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/privacy-policy" className="text-gray-400 hover:text-primary-400 text-sm transition hover-underline">{t('footer.privacyPolicy')}</Link></li>
              <li><Link to="/algemene-voorwaarden" className="text-gray-400 hover:text-primary-400 text-sm transition hover-underline">{t('footer.terms')}</Link></li>
              <li><Link to="/cookie-policy" className="text-gray-400 hover:text-primary-400 text-sm transition hover-underline">{t('footer.cookiePolicy')}</Link></li>
            </ul>
          </div>
          <div>
            ...
            <div className="space-y-3">
              ...
              <a href="https://wa.me/31636075966?text=Hallo!%20Ik%20wil%20graag%20een%20offerte%20aanvragen." target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-400 hover:text-green-400 text-sm transition">
        ...
        <div className="mt-10 pt-6 border-t border-dark-700/50 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-gray-500 text-xs">
            {t('footer.poweredBy')} <a href="https://varexo.nl" target="_blank" rel="noopener noreferrer" className="text-primary-400 hover:text-primary-300 hover-underline">Varexo</a>
          </p>
        </div>
      </div>
    </footer>
