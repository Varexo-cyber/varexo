                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 pb-4">
                    {projects.map((project) => (
                      ...
                      >
                        ...
                        {/* Contact Phone & Email */}
                        <div className="flex items-center gap-2 mb-1 text-xs text-primary-400">
                        ...
                        <div className="flex items-center gap-2 mb-3 text-xs text-primary-400">
                          ...
                          <a href="mailto:info@varexo.nl" className="hover:text-primary-300 transition">info@varexo.nl</a>
                        </div>
