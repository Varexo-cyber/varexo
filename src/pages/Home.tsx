    ...
    <PageTransition>
      ...
      <section className="relative bg-gradient-to-br from-dark-950 via-dark-900 to-dark-800 text-white py-28 code-rain scanlines">
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <AnimateOnScroll animation="reveal-left">
              ...
              <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight">
                Wij bouwen websites die klanten{' '}
                <span className="text-primary-400 text-glow-strong">opleveren.</span>
              </h1>
              <p className="text-xl mb-8 text-gray-300 max-w-lg">
                Professionele websites, webdevelopment en social media beheer voor ondernemers die willen groeien.
              </p>
          ...
          <div className="mt-16 pt-8 border-t border-dark-700/50">
            <p className="text-gray-500 text-sm text-center mb-4 uppercase tracking-widest">Onze tech stack</p>
      ...
      <section className="py-20 bg-dark-800 tech-grid">
        <div className="container mx-auto px-4">
          <AnimateOnScroll>
          <p className="text-primary-400 text-center font-mono text-sm mb-2 tracking-wider">&lt;services&gt;</p>
          <h2 className="text-3xl font-bold text-center mb-4 text-white">Wat we doen</h2>
          <p className="text-gray-400 text-center mb-12 max-w-xl mx-auto">Full-stack oplossingen van concept tot deployment</p>
          </AnimateOnScroll>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="glass-card card-hover p-6 rounded-xl text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Webdesign</h3>
              <p className="text-gray-400 text-sm">Pixel-perfect designs die converteren</p>
            </div>
            </AnimateOnScroll>
            ...
            <div className="glass-card card-hover p-6 rounded-xl text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Webdevelopment</h3>
              <p className="text-gray-400 text-sm">Clean code, snelle performance</p>
            </div>
            </AnimateOnScroll>
            ...
            <div className="glass-card card-hover p-6 rounded-xl text-center">
              ...
              <p className="text-gray-400 text-sm">Groei jouw bereik en engagement</p>
            </div>
            </AnimateOnScroll>
            ...
            <div className="glass-card card-hover p-6 rounded-xl text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Hosting & DevOps</h3>
              <p className="text-gray-400 text-sm">99.9% uptime, razendsnelle servers</p>
            </div>
            </AnimateOnScroll>
          </div>
          <p className="text-primary-400 text-center font-mono text-sm mt-12 tracking-wider">&lt;/services&gt;</p>
        </div>
      </section>
      ...
      <section className="py-20 bg-dark-800 matrix-dots">
        <div className="container mx-auto px-4">
          ...
          <h2 className="text-3xl font-bold text-center mb-12 text-white">Waarom Varexo</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center card-hover p-6 rounded-xl">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Snelle levering</h3>
              <p className="text-gray-400 text-sm">Agile development, snelle iteraties</p>
            </div>
            <div className="text-center card-hover p-6 rounded-xl">
              <div className="w-16 h-16 bg-gradient-to-br from-primary-500/20 to-primary-600/10 rounded-xl flex items-center justify-center mx-auto mb-4 border border-primary-500/20">
                <svg className="w-8 h-8 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Betaalbaar</h3>
              <p className="text-gray-400 text-sm">Transparante fixed-price pakketten</p>
            </div>
            <div className="text-center card-hover p-6 rounded-xl">
              <div className="w-16 h-16 bg-gradient-to-br from-primary-500/20 to-primary-600/10 rounded-xl flex items-center justify-center mx-auto mb-4 border border-primary-500/20">
                <svg className="w-8 h-8 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Persoonlijk</h3>
              <p className="text-gray-400 text-sm">Dedicated team, direct contact</p>
            </div>
            <div className="text-center card-hover p-6 rounded-xl">
              <div className="w-16 h-16 bg-gradient-to-br from-primary-500/20 to-primary-600/10 rounded-xl flex items-center justify-center mx-auto mb-4 border border-primary-500/20">
                <svg className="w-8 h-8 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Resultaat gericht</h3>
              <p className="text-gray-400 text-sm">Data-driven, focus op conversie</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <p className="font-mono text-primary-100 text-sm mb-4 tracking-wider">$ varexo --start-project</p>
          <h2 className="text-3xl md:text-4xl font-extrabold mb-4 text-white">Klaar om te deployen?</h2>
          <p className="text-xl mb-8 text-primary-100 max-w-xl mx-auto">
            Laten we jouw idee omzetten naar een snelle, schaalbare en professionele website.
          </p>
          <Link 
            to="/contact" 
